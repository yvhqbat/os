...
// VersionHandler - GET /os/admin/version
// -----------
...
// ServiceInfoHandler - GET /os/admin/v1/service
// ----------
...
// ServiceStopOrRestartHandler - POST /os/admin/v1/service
// ----------
// Returns server version and uptime.
...
// GetConfigHandler - GET /os/admin/v1/config
...
// AddUser - PUT /os/admin/v1/add-user?accessKey=<access_key>
...
// AddUser - GET /os/admin/v1/add-user?accessKey=<access_key>
...
// RemoveUser - GET /os/admin/v1/remove-user?accessKey=<access_key>
...
// ListUser - GET /os/admin/v1/list-users
